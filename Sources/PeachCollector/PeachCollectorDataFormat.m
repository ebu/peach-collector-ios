...
PCEventType const PCEventTypeCollectionItemDisplayed = @"collection_item_displayed";
...
NSString * const PCContextItemIndexKey = @"item_index";
NSString * const PCContextItemsCountKey = @"items_count";
...
NSString * const PCContextExperimentIDKey = @"experiment_id";
NSString * const PCContextExperimentComponentKey = @"experiment_component";
...
NSInteger const PeachCollectorDefaultMaxStoredEvents = 5000;
NSInteger const PeachCollectorDefaultMaxStorageDays = 30;
