...
- (void)checkInactivity
{
    ...
    NSInteger currentTimestamp = (int)([[NSDate date] timeIntervalSince1970] * 1000);
...
{
    [PeachCollector sharedCollector].lastRecordedEventTimestamp = (int)([[NSDate date] timeIntervalSince1970] * 1000);
