...
- (void)checkInactivity
{
    ...
    NSInteger currentTimestamp = [[NSDate date] gmtMillisecondsTimestamp];
...
{
    [PeachCollector sharedCollector].lastRecordedEventTimestamp = [[NSDate date] gmtMillisecondsTimestamp];
